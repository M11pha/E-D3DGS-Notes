...
def readColmapSceneInfoDynerf(path, images, eval, duration=300, testonly=None):
    '''
    path   = args.source_path = '/home/ekko/datasets/Neural_3D_Video/cook_spinach' 数据集所在地址
    images = args.source_path = '/home/ekko/datasets/Neural_3D_Video/cook_spinach' 数据集所在地址
    eval   = args.eval = True
    duration  = 300
    '''
    # 从数据集路径下的colmap文件夹加载相机外参与内参
    try:
